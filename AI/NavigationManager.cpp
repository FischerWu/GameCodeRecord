...
// 修改setMap函数以接收Scene对象
void NavigationManager::setMap(Scene * s)
{
    map = s->getMap();
    mapWidth = s->getMapWidth();
    mapHeight = s->getMapHeight();
    navigableGrids = s->getNavigableGridList();
}
